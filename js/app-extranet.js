...
async function showExtranetDashboard(userEmail, accessToken){
  ...
  try{
    ...
    document.getElementById('extranet-pending').textContent = orders.filter(o => o.statut !== 'rapport_dispo' && o.statut !== 'confirmee').length;
    document.getElementById('extranet-done').textContent = orders.filter(o => o.statut === 'rapport_dispo').length;
